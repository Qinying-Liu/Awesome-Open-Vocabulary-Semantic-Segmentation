...
3. <span id = "1003">**[Xu et al.]**</span> | **ECCV'22** | A Simple Baseline for Open-Vocabulary Semantic Segmentation with Pre-trained Vision-language Model | [`[pdf]`](https://arxiv.org/pdf/2112.14757.pdf) | [`[code]`](https://github.com/MendelXu/zsseg.baseline)
4. <span id = "1003">**[SegCLIP]**</span> | **ICML'23** | SegCLIP: Patch Aggregation with Learnable Centers for Open-Vocabulary Semantic Segmentation | [`[pdf]`](https://arxiv.org/pdf/2211.14813.pdf) | [`[code]`](https://github.com/ArrowLuo/SegCLIP)
...
3. <span id = "2003">**[SegCLIP]**</span> | **ICML'23** | SegCLIP: Patch Aggregation with Learnable Centers for Open-Vocabulary Semantic Segmentation | [`[pdf]`](https://arxiv.org/pdf/2211.14813.pdf) | [`[code]`](https://github.com/ArrowLuo/SegCLIP)
4. <span id = "2004">**[SegCLIP]**</span> | **CVPR'23** | Open Vocabulary Semantic Segmentation with Patch Aligned Contrastive
Learning | [`[pdf]`](https://arxiv.org/pdf/2211.14813.pdf)
