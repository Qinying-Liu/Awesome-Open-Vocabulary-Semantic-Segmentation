...
3. <span id = "1003">**[OpenSeg]**</span> | **ECCV'22** | A Simple Baseline for Open-Vocabulary Semantic Segmentation with Pre-trained Vision-language Model | [`[pdf]`](https://arxiv.org/pdf/2112.14757.pdf) | [`[code]`](https://github.com/MendelXu/zsseg.baseline)
